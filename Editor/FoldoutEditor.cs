    ...
    public override void OnInspectorGUI()
    {
        ...
        void Foldout(CacheFoldProp cache)
        {
            ...
            if (cache.expanded)
            {
                ...
                {
                    this.UseVerticalLayout(() => Child(i), StyleFramework.boxChild, cache.atr.styled);
                }
            }
...
{
    public static void UseVerticalLayout(this Editor e, Action action, GUIStyle style, bool styled)
    {
